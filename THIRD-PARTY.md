...
Этот репозиторий содержит только исходники локальных исправлений, перевод,
конфигурацию и инструменты упаковки. Сторонние бинарные файлы скачиваются
лаунчером по CurseForge-манифесту либо прозрачным TLauncher-установщиком с
проверкой зафиксированных контрольных сумм.
